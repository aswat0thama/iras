...
// Mathematics concept map data (existing)
const mathematicsNodes = [
  {
    id: '1',
    type: 'custom',
    position: { x: 400, y: 50 },
...
export default function ConceptMap({ subject = 'mathematics' }) {
  // Get appropriate nodes and edges based on subject
  ...
  // Update nodes and edges when subject changes
  useEffect(() => {
